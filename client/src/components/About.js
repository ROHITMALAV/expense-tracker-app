    ...
    <div>
      ...
      <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-md">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Financial Clarity, Simplified.</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12 text-center">
          <div className="feature-card">
            <img src="https://placehold.co/600x400/10b981/ffffff?text=Dashboard" alt="Dashboard" className="rounded-lg mb-4"/>
          ...
          <div className="feature-card">
            <img src="https://placehold.co/600x400/3b82f6/ffffff?text=Secure" alt="Secure" className="rounded-lg mb-4"/>
                ...
                {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="text-right">
                            <button type="submit" className="btn btn-primary w-auto" disabled={isLoading}>
        ...
        <div className="text-center mt-12">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
                <div className="text-center">
                    <img src="/Rt.jpeg" alt="Rohit Malav" className="rounded-full mx-auto mb-4 shadow-md w-32 h-32 object-cover"/>
                    <h4 className="text-xl font-semibold">Rohit Malav</h4>
                    <p className="text-gray-500">Full-Stack Developer</p>
                </div>
                <div className="text-center">
                    <img src="/Sm.jpeg" alt="Sanjay Mishra" className="rounded-full mx-auto mb-4 shadow-md w-32 h-32 object-cover"/>
